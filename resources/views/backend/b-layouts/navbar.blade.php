<header class="main-header">
            <a href="index.html" class="logo">
               ...
               <img src="{{url('backend/assets/dist/img/mini-logo.png')}}" alt="">
               </span>
               <span class="logo-lg">
               <img src="{{url('backend/assets/dist/img/logo.png')}}" alt="">
               </span>
            </a>
            <!-- Header Navbar -->
             ...
             <div class="navbar-custom-menu">
                  <ul class="nav navbar-nav">
                     ...
                     <li class="dropdown dropdown-user">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="{{url('backend/assets/dist/img/avatar5.png')}}" class="img-circle" width="45" height="45" alt="user"></a>
                        <ul class="dropdown-menu" >
                           <li>
                              <a href="profile.html">
